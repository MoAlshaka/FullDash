...
<html lang="en" class="light-style layout-wide customizer-hide"
    ...
    @else
        dir="ltr" @endif data-theme="theme-default"
...
<head>
    ...
    <title> {{ env('APP_NAME') }}-{{ __('title.AdminLogin') }} </title>
        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <!-- /Logo -->
                    <h3 class="mb-1"> {{ __('site.WelcomeTo') }} {{ env('APP_NAME') }} 👋!</h3>
                    <p class="mb-4">{{ __('site.Please sign-in to your account and start the adventure') }}</p>

                    <form id="formAuthentication" class="mb-3" action="{{ route('admin.login') }}" method="Post">
                        @csrf
                        <div class="mb-3">
                            <label for="username" class="form-label">{{ __('site.Username') }}<span
                        ...
                        <div class="mb-3 form-password-toggle">
                            <div class="d-flex justify-content-between">
                                <label class="form-label" for="password">{{ __('site.Password') }}<span
                                        class="text-danger">*</span></label>
